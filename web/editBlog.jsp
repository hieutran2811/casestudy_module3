    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarResponsive">
            <ul class="navbar-nav ml-auto">
                ...
                <%--                </li>--%>
                <li class="nav-item">
                    <%--                    <p class="lead"><c:out value="${account.getAccount}"/></p>--%>
...
<div class="container">
    <div class="row">
        <div class="col-lg-8">
            ...
            <div class="card-body">
                <form method="post" action="/myblog?action=edit blog&id=${blog.id}&user=${blog.user_name}">
                    <div class="form-group">
                        Blog Name : <input type="text" class="form-control" rows="3" name="name" value="${blog.name}"><br>
                        Content:
...
<%--                <a href="/myblog?action=editBlog&id=${blog.id}">edit</a>--%>
<%--                <a href="/myblog?action=deleteBlog&id=${blog.id}">delete</a>--%>
<%--                <hr>--%>
...
<%--                            <a href="/myblog?action=editComments&id=${comments.id}">edit</a>--%>
<%--                            <a href="/myblog?action=deleteComments&id=${comments.id}">delete</a>--%>
